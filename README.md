...
The home page of the website will include links to all other pages, these links will be stylized, such as large card-style elements that will have interactive hover states. The nav bar will have the Logo and Sitename to the left, and 4 links on the right. the four links will be Events, History, Museum and Contact. other than the Events link, all other will be drop down menus with more links that open when hovered upon. 
...
The book of remembrance will have a carousel of different individuals and will include a search function that users can use to find specific database entries. This page will be Dynamic, and manaaged by the Client Management System Through the Dashboard.
