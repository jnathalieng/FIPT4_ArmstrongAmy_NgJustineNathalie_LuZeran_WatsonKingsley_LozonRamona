    ...
    <div class="manager-container">
        ...
        <div class="manager-container">
            <div class="manager-header">
                <h2 class="r-header-text">Gallery Manager</h2>
                <button class="create-button add-button publish-button" @click="openAddGalleryModal">
                    + New Gallery
                </button>
            </div>
            ...
            >
                ...
                <div class="gallery-header-row" @click="toggleGallery(gallery.id)">
                    <div class="gallery-header-left">
                        ...
                        <div class="header-row-title">
                            ...
                            <span class="gallery-meta b-body-text">{{ gallery.slug }} &mdash; {{ gallery.images ? gallery.images.length : 0 }} image(s)</span>
                        </div>
                    </div>
                    <div class="gallery-header-actions" @click.stop>
                        <button class="add-button save-button" @click="openEditGalleryModal(gallery)">Edit Gallery</button>
                        <button class="add-button publish-button" @click="confirmDeleteGallery(gallery)">Delete Gallery</button>
                    </div>
                </div>
                ...
                <div v-if="openGalleries.includes(gallery.id)" class="gallery-images-panel">
                    ...
                    <div class="images-panel-header">
                        ...
                        <button class="add-button save-button" @click="openAddImageModal(gallery)">+ Add Image</button>
                    </div>
                        ...
                        <div class="image-list-header">
                            ...
                            <div
                                ...
                                class="image-list-item">
                                    <div data-label="Preview">
                                        <img 
                                            :src="'/images/' + (image.folder_path || gallery.folder_path) + '/mobile/' + (image.filename_mobile || image.filename_desktop)"
                                            :alt="image.alt_text"
                                            class="image-thumb"
                                    ...
                                    <div class="image-actions" data-label="Actions">
                                        <button class="add-button save-button" @click="openEditImageModal(image, gallery)">Edit</button>
                                        <button class="add-button publish-button" @click="confirmDeleteImage(image, gallery)">Delete</button>
                                    </div>
                                </div>
                            </div>
