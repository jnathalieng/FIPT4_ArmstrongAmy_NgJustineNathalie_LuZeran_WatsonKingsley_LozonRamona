...
template: `
    <div class="gallery-container">
        ...
        <section class="gallery-info" v-if="currentGallery">
            <h2 class="r-header-text">{{ currentGallery.title.toUpperCase() }}</h2>
            <h3 class="r-body-text">{{ currentGallery.subtitle }}</h3>
            <p class="small-text">{{ currentGallery.description }}</p>
        </section>
